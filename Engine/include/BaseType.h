...
#define CLS_KLBUIPOLYLINE2		(48| CLS_KLBUSERTASK)
#define CLS_KLBUIPOLYGON		(49| CLS_KLBUSERTASK)
#define CLS_KLBUIRUBBERBAND		(50| CLS_KLBUSERTASK)
#define CLS_KLBUISCALE9			(51| CLS_KLBUSERTASK)
#define CLS_KLBUISIMPLEITEM		(52| CLS_KLBUSERTASK)
#define CLS_KLBUITEXTINPUT		(53| CLS_KLBUSERTASK)

// export objects
#define CLS_KLBBINARRAY     (54| CLS_KLBENGINECLASS)
#define CLS_KLBLUADB        (55| CLS_KLBENGINECLASS)
#define CLS_KLBDATASET      (56| CLS_KLBENGINECLASS)
#define CLS_KLBNODEVIRTUALDOC	(57 | CLS_KLBENGINECLASS | CLS_KLBUICORECLASS)
#define CLS_KLBFONTOBJ		(58| CLS_KLBENGINECLASS)
#define CLS_KLBSOUNDOBJ		(59| CLS_KLBENGINECLASS)
#define CLS_KLBMATRIXOBJ	(60| CLS_KLBENGINECLASS)
#define CLS_KLBVECTOROBJ	(61| CLS_KLBENGINECLASS)

#define CLS_KLBUNITTASK		(62| CLS_KLBUSERTASK)
#define CLS_KLBMAPGROUP		(63| CLS_KLBUSERTASK)

#define CLS_KLBSTORESERVICE	(64| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBNETAPI		(65| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBPAUSECTRL	(66| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBLIFECTRL		(67| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBAIDRIVERTASK	(68| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBWORDLTASK	(69| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBUIWEBVIEW	(70| CLS_KLBUSERTASK)

#define CLS_KLBAPPPROP		(71| CLS_KLBENGINECLASS)

#define CLS_KLBACTIVITYINDICATORNODE    (72| CLS_KLBENGINECLASS)    // CKLBActivityIndicatorNode
#define CLS_KLBUIACTIVITYINDICATOR      (73| CLS_KLBUSERTASK)    // CKLBUIActivityIndicator

#define CLS_KLBUIVARIABLEITEM			(74| CLS_KLBUSERTASK)
#define CLS_KLBUICLIP					(75| CLS_KLBUSERTASK)
#define CLS_KLBAPPUPDATE				(76| CLS_KLBENGINECLASS)
#define CLS_KLBASYNCLOADER				(77| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBGCTASK					(78| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBAPPUPDATEZIP				(79| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBASYNCFILECOPY			(80| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
